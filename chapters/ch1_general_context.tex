...
Both applications share the same backend API (Express.js on port 3001), the same PostgreSQL database, and the same authentication system (Supabase Auth + JWT), enabling seamless Single Sign-On between the two apps.
