...
% Usage: \toolentry{logo_file}{Tool Name}{description \cite{}}
...
% ---- Sprint badge (inline colored label) ----
% Usage: \sprintbadge{1}  \sprintbadge{2} ... \sprintbadge{5}
\definecolor{s1color}{RGB}{31,78,121}    % isiBlue
\definecolor{s2color}{RGB}{0,130,80}     % igsGreen-ish
\definecolor{s3color}{RGB}{180,80,0}     % burnt orange
\definecolor{s4color}{RGB}{100,30,140}   % purple
\definecolor{s5color}{RGB}{180,20,20}    % dark red
...
% ---- UML Stick-figure Actor (Visual Paradigm style) ----
% Usage inside any tikzpicture:
%   \umlactor{nodename}{x}{y}{Actor Label}
% The node "nodename" can then be referenced for drawing associations.
\newcommand{\umlactor}[4]{%
  \begin{scope}[shift={(#2,#3)}]
    ...
    \draw[draw=darkGray, line width=0.6pt] (0,-0.15) -- ( 0.22,-0.55);
    % invisible bounding node that anchors associations
...
% Usage: \chapterintro{Introductory paragraph text.}
\newcommand{\chapterintro}[1]{%
  \begin{tcolorbox}[
    ...
    bottomrule=0.4pt,
    arc=4pt,
    top=7pt, bottom=7pt, left=10pt, right=8pt,
    before upper={\noindent\textbf{\color{isiBlue}Introduction}\par\smallskip},
    fontupper=\small,
  ]
  #1
  \end{tcolorbox}
...
\begin{center}
  \textbf{Carried out at:}\\[6pt]
  \includegraphics[height=3cm]{images/logos/igs.jpg}\\[4pt]
...
% ---- Competitor platforms (screenshots in Chapter 1) ----
